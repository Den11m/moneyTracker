...
const Header = props => {
  ...
  return (
    <div className="header">
      <div
        className="progress-bar-fact"
        style={{
          backgroundImage: `linear-gradient(to right, red ${styleBar}, green ${styleBar})`
        }}
      >
        <BudgetRender />
        <nav className="header-nav">
          {props.isLogin ? (
            <button className="header-button" onClick={props.logout}>
              Log Out
            </button>
          ) : (
            <div>
              <button
                ...
                onClick={props.toggleShowRegistration}
              >
                Sign Up
              </button>
              <button className="header-button" onClick={props.toggleShowLogin}>
                Login
              </button>
            </div>
          )}
